...
- Go to Frontend/src/components/cart folder then create new file CheckoutSteps.jsx file & add the code :
...
- Go to frontend/src/components/cart/ConfirmOrder.jsx file & update the code :
...
- Go to frontend/src/redux/apiorderApi.js file & update the code :
...
- Go to frontend/src/components/review folder then create new file `ListReviews.jsx` file & update the code :
...
- go to frontend/src/redux/api/productApi.js file & update the code :
